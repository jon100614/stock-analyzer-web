...
with st.sidebar:
    ...
    symbols_text = st.text_area(
        ...
        help="以逗號分隔，例如：AAPL,MSFT,TSLA,2330,3138.TWO。輸入後按 Enter 或點開始篩選。",
        on_change=trigger_screener,
    )
    ...
    st.button("開始篩選", type="primary", on_click=trigger_screener)

if st.session_state.screener_run:
    st.session_state.screener_run = False
